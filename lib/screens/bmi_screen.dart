...
class _BmiScreenState extends State<BmiScreen> {
  ...
  Widget build(BuildContext context) {
    heightMessage = 'Please insert your height in '
    + ((isMetric) ? 'centimeters' : 'inches');
    weightMessage = 'Please insert your weight in '
  ...
  void findBMI() {
    double bmi = 0;
    double height = double.tryParse(txtHeight.text) ?? 0; // tryParse returns null if it fails
